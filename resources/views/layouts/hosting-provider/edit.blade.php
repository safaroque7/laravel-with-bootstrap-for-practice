    ...
    <div class="col-md-10 mt-md-3 mt-2 mb-md-4 mb-3">
        ...
        <div class="row mb-md-3 mb-2">
            <div class="col-md-4">
                ...
                <form action="{{ route('update-hosting-provider', $editableHostingProvidersName->id) }}" method='POST'>
                    @csrf

                    <label for="category-name" class="form-label"> Hosting provider's Name </label>
                    <input autofocus type="text" name="name" class="form-control mb-md-3 border-@if($errors->has('name')){{ __('danger') }} @endif" value="{{ __($editableHostingProvidersName->name) }}">
